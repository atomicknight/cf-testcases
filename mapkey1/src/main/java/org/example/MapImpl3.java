...
public class MapImpl3 implements Map<String, String> {
	private final Map<String, String> delegate = new HashMap<>();

	@Override
	public Set<@KeyFor("this.delegate") String> keySet() {
		return delegate.keySet();
	}

	@Override
	public Set<Map.Entry<@KeyFor("this.delegate") String, String>> entrySet() {
